...
package com.hpcang.mvp.delegate;
...
import com.hpcang.mvp.MvpPresenter;
import com.hpcang.mvp.MvpView;
...
public interface FragmentMvpDelegate<V extends MvpView, P extends MvpPresenter<V>> {
  ...
  /**
   * Must be called from {@link #onCreate(Bundle)}
   *
  ...
  /**
   * Must be called from {@link #()}
   */
  void onDestroy();

  /**
   * Must be called from {@link #onViewCreated(View, Bundle)}
   *
  ...
  /**
   * Must be called from {@link #onDestroyView()}
   */
  void onDestroyView();

  /**
   * Must be called from {@link #onPause()}
   */
  void onPause();

  /**
   * Must be called from {@link #onResume()}
   */
  void onResume();

  /**
   * Must be called from {@link #onStart()}
   */
  void onStart();

  /**
   * Must be called from {@link #onStop()}
   */
  void onStop();

  /**
   * Must be called from {@link #onActivityCreated(Bundle)}
   *
  ...
  /**
   * Must be called from {@link #onAttach(Activity)}
   *
  ...
  /**
   * Must be called from {@link #onAttach(Context)}
   *
  ...
  /**
   * Must be called from {@link #onDetach()}
   */
  void onDetach();

  /**
   * Must be called from {@link #onSaveInstanceState(Bundle)}
   */
